...
OV_SETTINGS=" --outputVolumeSpacing ${OV_SPACING} --outputVolumeOrigin ${OV_ORIGIN} --outputVolumeOrientationCode ${OV_ORIENTATION_CODE}  --output-volume-permute-axes ${OV_PERMUTATION} --outputVolumeScalarType ${OV_TYPE} --flip ${OV_FLIP}"
