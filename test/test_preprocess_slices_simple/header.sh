...
OUTPUT_VOLUME_PROPERTIES=" --outputVolumeOrientationCode ${OUTPUT_VOLUME_ORIENTATION} --outputVolumeSpacing ${OUTPUT_VOLUME_SPACING} --outputVolumePermutationOrder ${OUTPUT_VOLUME_PERMUTATION} --flip ${OUTPUT_VOLUME_FLIPPING} --outputVolumeOrigin ${OUTPUT_VOLUME_ORIGIN}"
