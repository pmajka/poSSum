...
alphaChannelFunc.AddPoint(230, 1.0)
alphaChannelFunc.AddPoint(240, 0.0)
alphaChannelFunc.AddPoint(255, 0.0)

# This class stores color data and can create color tables from a few color points. For this demo, we want the three cubes
# to be of the colors red green and blue.
colorFunc = vtk.vtkColorTransferFunction()
colorFunc.AddRGBPoint(0, 0.2, 0.2, 0.2)
colorFunc.AddRGBPoint(80, 0.2, 0.2, 0.2)
colorFunc.AddRGBPoint(110, 0.2, 0.2, 0.2)
colorFunc.AddRGBPoint(150, 0.6, 0.6, 0.6)
colorFunc.AddRGBPoint(255, 1.0, 1.0, 1.0)

gtfun = vtk.vtkPiecewiseFunction()
gtfun.AddPoint(0, 0.0)
gtfun.AddPoint(100, 0.2)
