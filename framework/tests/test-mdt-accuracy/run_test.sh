...
for i in range(n):
    ...
    v=s
    v2=192
    print "convert -size ${image_size}x${image_size} xc:black -fill white -stroke none -draw \"rectangle %d,%d %d,%d\" img_%03d.png; c2d img_%03d.png -o %04d.nii.gz" %(v,v,v2,v2, i, i, i)
END
}
