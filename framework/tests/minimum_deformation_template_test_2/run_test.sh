...
cp -rfv /dev/shm/minimum_deformation_template_test_2/12_transf_f/sddm0009.nii.gz test_sddm.nii.gz
cp -rfv /dev/shm/minimum_deformation_template_test_2/05_iterations/0009/21_resliced/average.nii.gz test_average.nii.gz
